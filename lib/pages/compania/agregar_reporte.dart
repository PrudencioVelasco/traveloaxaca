...
class ReportarComentarioCompaniaPage extends StatefulWidget {
  final ComentarioCompania? comentario;
  ReportarComentarioCompaniaPage({Key? key, required this.comentario})
      : super(key: key);

  @override
  _ReportarComentarioCompaniaPageState createState() =>
      _ReportarComentarioCompaniaPageState();
}

class _ReportarComentarioCompaniaPageState
    extends State<ReportarComentarioCompaniaPage> {
