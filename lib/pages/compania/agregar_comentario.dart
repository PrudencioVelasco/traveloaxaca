...
class AgregarComentarioCompaniaPage extends StatefulWidget {
  final Compania? compania;
  AgregarComentarioCompaniaPage({Key? key, required this.compania})
      : super(key: key);

  @override
  _AgregarComentarioCompaniaPageState createState() =>
      _AgregarComentarioCompaniaPageState();
}

class _AgregarComentarioCompaniaPageState
    extends State<AgregarComentarioCompaniaPage> {
  List<Asset> images = [];
    ...
    try {
      resultList = await MultiImagePicker.pickImages(
        ...
        materialOptions: MaterialOptions(
          ...
          actionBarTitle: widget.compania!.nombre.toString(),
