...
class ComentariosCompaniaPage extends StatefulWidget {
  final Compania compania;
  final String collectionName;
  const ComentariosCompaniaPage(
      {Key? key, required this.compania, required this.collectionName})
      : super(key: key);

  @override
  _ComentariosCompaniaPageState createState() =>
      _ComentariosCompaniaPageState();
}

class _ComentariosCompaniaPageState extends State<ComentariosCompaniaPage> {
...
//_listComentarios
      _listComentarios = (await _commentsBloc.obtenerComentariosCompania(
          widget.compania.idcompania!, 0, 7));
    } else {
      // data = await firestore
      _data = (await _commentsBloc.obtenerComentariosCompania(
          widget.compania.idcompania!, _idComentarioUltimo, 7));
