...
class CompaniaComentarioPage extends StatefulWidget {
  final Compania compania;
  CompaniaComentarioPage({Key? key, required this.compania}) : super(key: key);

  @override
  _CompaniaComentarioPageState createState() => _CompaniaComentarioPageState();
}

class _CompaniaComentarioPageState extends State<CompaniaComentarioPage> {
  bool? _hasData;
