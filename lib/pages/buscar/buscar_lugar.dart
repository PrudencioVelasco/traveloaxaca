...
class BuscarLugarPage extends StatefulWidget {
  final String? nombre;
  final int? idclasificacion;
  const BuscarLugarPage(
      {Key? key, required this.nombre, required this.idclasificacion})
      : super(key: key);

  @override
  _BuscarLugarPageState createState() => _BuscarLugarPageState();
}

class _BuscarLugarPageState extends State<BuscarLugarPage> {
