...
class MapaBusquedaPage extends StatefulWidget {
  ...
  MapaBusquedaPage({Key? key, required this.listalugares}) : super(key: key);

  @override
  _MapaBusquedaPageState createState() => _MapaBusquedaPageState();
}
...
class _MapaBusquedaPageState extends State<MapaBusquedaPage> {
  ...
  Future getData() async {
    ...
    if (widget.listalugares.length == 0) {
      openEmptyDialog();
    } else {
      widget.listalugares.forEach((element) {
