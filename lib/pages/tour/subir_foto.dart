...
class SubirFotoComentarioTour extends StatefulWidget {
  final Tour? tour;
  SubirFotoComentarioTour({Key? key, required this.tour}) : super(key: key);

  @override
  _SubirFotoComentarioTourState createState() =>
      _SubirFotoComentarioTourState();
}

class _SubirFotoComentarioTourState extends State<SubirFotoComentarioTour> {
  List<Asset> images = [];
  ...
  Future btnSubirFotos() async {
    ...
    bool dato =
        await _commentsBloc.subirFotosTour(widget.tour!.idtour!, images);
