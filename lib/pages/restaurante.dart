...
class RestaurantePage extends StatefulWidget {
  ...
  RestaurantePage({Key? key, required this.placeData}) : super(key: key);
...
class _RestaurantePageState extends State<RestaurantePage> {
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        '${widget.placeData!.nombre!} - Nearby Restaurants',
                        style: TextStyle(
  ...
  void animateCameraAfterInitialization() {
    _controller!.animateCamera(CameraUpdate.newCameraPosition(CameraPosition(
      target: LatLng(widget.placeData!.latitud!, widget.placeData!.longitud!),
      zoom: 13,
    )));
  }
