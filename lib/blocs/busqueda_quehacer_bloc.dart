...
class BusquedaQueHacerBloc with ChangeNotifier {
  SearchBloc() {
    getRecentSearchList();
  }
  ...
  Future getRecentSearchList() async {
    ...
    _recentSearchData = sp.getStringList('recent_search_data_que_hacer') ?? [];
    notifyListeners();
  }
  ...
  Future addToSearchList(String value) async {
    ...
    await sp.setStringList('recent_search_data_que_hacer', _recentSearchData);
    notifyListeners();
  }
